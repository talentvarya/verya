...
public class MainActivity extends Activity {
    ...
    private void startTracking() { requestLocationPermissions(); Intent i = new Intent(this, LocationService.class); if (Build.VERSION.SDK_INT >= 26) startForegroundService(i); else startService(i); status.setText("Tracking active. Keep the Veyra notification enabled."); }
