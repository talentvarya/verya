...
public class MainActivity extends Activity {
    ...
    private void buildUi() {
        ...
        TextView info = new TextView(this); info.setText("Pair this phone with your Veyra account. Verify continues only after Camera, Microphone, Notifications and Location ‘Allow all the time’ permissions are granted."); root.addView(info);
